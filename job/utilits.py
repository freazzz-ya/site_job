def get_date_range(date_list):
    """
    Находит 2 даты (самую раннюю и самую позднюю) и промежуток времени с этих дат.

    Args:
        date_list: список дат.

    Returns:
        Кортеж из самой ранней даты, самой поздней даты и промежутка времени между ними.
    """
